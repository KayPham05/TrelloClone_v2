...
export default function RightSidebar({
  ...
  return (
    <aside
      ...
      } bg-white border-l flex flex-col transition-all duration-300 ease-in-out dark:bg-neutral-800  ${className} `}
    >
                  ...
                  >
                    <div
                      className={`${isCollapsed ? "w-9 h-9" : "w-10 h-9"} 
                                    ...
                                    flex-shrink-0 shadow-md group-hover:shadow-lg transition`}
                    >
        ...
        <div>
          ...
          <div className="space-y-3">
            <button
              ...
              } bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 border border-blue-200 rounded-lg transition group`}
              title={isCollapsed ? "Tạo bảng mới" : ""}
            >
              <div
                className="min-w-9 min-h-9 w-9 h-9 bg-blue-500 
    rounded-lg flex items-center justify-center 
